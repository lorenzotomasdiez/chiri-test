  ...
  return (
    ...
    >
      ...
      <button
        ...
        aria-label="Dismiss"
        onClick={onDismiss}
        className="shrink-0 rounded text-muted/80 hover:text-ink focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-ink"
      >
